...
async function testCSVExporter() {
    ...
    csvExporter_1.CSVExporter.printToConsole(samplePredictions);
    console.log('\n\nTest 2: Print CSV View');
    console.log('-'.repeat(50));
    csvExporter_1.CSVExporter.printCsvToConsole(samplePredictions);
    console.log('\n\nTest 3: Save to File');
    console.log('-'.repeat(50));
    try {
        const filepath = csvExporter_1.CSVExporter.saveToFile(samplePredictions, './output');
    ...
    console.log('-'.repeat(50));
    const summary = csvExporter_1.CSVExporter.generateSummary(samplePredictions);
...
//# sourceMappingURL=csvExporterTest.js.map